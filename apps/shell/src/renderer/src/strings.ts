...
export const strings = {
  zh: {
    ...
    // Quick start
    newDoc: 'AI Docs',
    newSheet: 'mAI Office Sheets',
    newSlide: 'mAI Office Slides',
    openLocal: '打开本地文件',
    greetMorning: '早上好',
    greetAfternoon: '下午好',
    greetEvening: '晚上好',
    ...
    noContent: '（无内容）',
    // Account
    accountGenspark: 'mAI Office 账号',
    account: '账号',
    login: '登录',
    loginGenspark: '登录 mAI Office',
    loggedIn: '已登录',
    loggedInGenspark: '已登录 mAI Office',
    ...
    onbTitle1: '欢迎使用 mAI Office',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'mAI Office 目前处于 alpha 阶段。加入 GenTeam 群聊，一起交流。',
  ...
  en: {
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountGenspark: 'mAI Office account',
    account: 'Account',
    login: 'Sign in',
    loginGenspark: 'Sign in to mAI Office',
    loggedIn: 'Signed in',
    loggedInGenspark: 'Signed in to mAI Office',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to mAI Office',
    ...
    onbBody2: 'mAI Office is still in alpha. Join the group chat on GenTeam.',
  ...
  ja: {
    ...
    noContent: '（内容なし）',
    // Account
    accountGenspark: 'mAI Office アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginGenspark: 'mAI Office にサインイン',
    loggedIn: 'サインイン済み',
    loggedInGenspark: 'mAI Office にサインイン済み',
    waitingLogin:
  ...
  ko: {
    ...
    noContent: '(내용 없음)',
    // Account
    accountGenspark: 'mAI Office 계정',
    account: '계정',
    login: '로그인',
    loginGenspark: 'mAI Office 로그인',
    loggedIn: '로그인됨',
    loggedInGenspark: 'mAI Office에 로그인됨',
  ...
  fr: {
    ...
    noContent: '(vide)',
    // Account
    accountGenspark: 'Compte mAI Office',
    account: 'Compte',
    login: 'Se connecter',
    loginGenspark: 'Se connecter à mAI Office',
    loggedIn: 'Connecté',
    loggedInGenspark: 'Connecté à mAI Office',
    waitingLogin:
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans mAI Office',
    ...
    onbBody2: 'mAI Office est encore en alpha. Rejoignez la discussion de groupe sur GenTeam.',
  ...
  de: {
    ...
    noContent: '(leer)',
    // Account
    accountGenspark: 'mAI Office-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginGenspark: 'Bei mAI Office anmelden',
    loggedIn: 'Angemeldet',
    loggedInGenspark: 'Bei mAI Office angemeldet',
    waitingLogin:
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei mAI Office',
    ...
    onbBody2: 'mAI Office ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GenTeam bei.',
  ...
  es: {
    ...
    noContent: '(vacío)',
    // Account
    accountGenspark: 'Cuenta de mAI Office',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginGenspark: 'Iniciar sesión en mAI Office',
    loggedIn: 'Sesión iniciada',
    loggedInGenspark: 'Sesión iniciada en mAI Office',
    waitingLogin:
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a mAI Office',
    ...
    onbBody2: 'mAI Office aún está en alfa. Únete al chat grupal en GenTeam.',
  ...
  th: {
    ...
    // Account
    accountGenspark: 'บัญชี mAI Office',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginGenspark: 'ลงชื่อเข้าใช้ mAI Office',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInGenspark: 'ลงชื่อเข้าใช้ mAI Office แล้ว',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ mAI Office',
    ...
    onbBody2: 'mAI Office ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GenTeam',
  ...
  id: {
    ...
    noContent: '(kosong)',
    // Account
    accountGenspark: 'Akun mAI Office',
    account: 'Akun',
    login: 'Masuk',
    loginGenspark: 'Masuk ke mAI Office',
    loggedIn: 'Sudah masuk',
    loggedInGenspark: 'Sudah masuk ke mAI Office',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di mAI Office',
    ...
    onbBody2: 'mAI Office masih dalam tahap alpha. Gabung obrolan grup di GenTeam.',
  ...
  ru: {
    ...
    noContent: '(пусто)',
    // Account
    accountGenspark: 'Учётная запись mAI Office',
    account: 'Учётная запись',
    login: 'Войти',
    loginGenspark: 'Войти в mAI Office',
    loggedIn: 'Вход выполнен',
    loggedInGenspark: 'Выполнен вход в mAI Office',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в mAI Office',
    ...
    onbBody2: 'mAI Office пока в альфа-версии. Присоединяйтесь к групповому чату в GenTeam.',
  ...
  ar: {
    ...
    noContent: '(فارغ)',
    // Account
    accountGenspark: 'حساب mAI Office',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginGenspark: 'تسجيل الدخول إلى mAI Office',
    loggedIn: 'تم تسجيل الدخول',
    loggedInGenspark: 'تم تسجيل الدخول إلى mAI Office',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في mAI Office',
    ...
    onbBody2: 'لا يزال mAI Office في مرحلة ألفا. انضم إلى الدردشة الجماعية على GenTeam.',
  ...
  pt: {
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountGenspark: 'Conta mAI Office',
    account: 'Conta',
    login: 'Entrar',
    loginGenspark: 'Entrar no mAI Office',
    loggedIn: 'Conectado',
    loggedInGenspark: 'Conectado ao mAI Office',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao mAI Office',
    ...
    onbBody2: 'O mAI Office ainda está em alfa. Entre no chat em grupo no GenTeam.',
  ...
  it: {
    ...
    noContent: '(vuoto)',
    accountGenspark: 'Account mAI Office',
    account: 'Account',
    login: 'Accedi',
    loginGenspark: 'Accedi a mAI Office',
    loggedIn: 'Accesso effettuato',
    loggedInGenspark: 'Accesso effettuato a mAI Office',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in mAI Office',
    ...
    onbBody2: 'mAI Office è ancora in alpha. Unisciti alla chat di gruppo su GenTeam.',
  ...
  pl: {
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountGenspark: 'Konto mAI Office',
    account: 'Konto',
    login: 'Zaloguj się',
    loginGenspark: 'Zaloguj się do mAI Office',
    loggedIn: 'Zalogowano',
    loggedInGenspark: 'Zalogowano do mAI Office',
    waitingLogin:
    ...
    onbBody2: 'mAI Office jest wciąż w fazie alfa. Dołącz do czatu grupowego na GenTeam.',
  ...
  nl: {
    ...
    account: 'Account',
    login: 'Inloggen',
    loginGenspark: 'Inloggen bij mAI Office',
    loggedIn: 'Ingelogd',
    loggedInGenspark: 'Ingelogd bij mAI Office',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij mAI Office',
    ...
    onbBody2: 'mAI Office is nog in alfa. Doe mee aan de groepschat op GenTeam.',
  ...
  ms: {
    ...
    noContent: '(kosong)',
    accountGenspark: 'Akaun mAI Office',
    account: 'Akaun',
    login: 'Log masuk',
    loginGenspark: 'Log masuk ke mAI Office',
    loggedIn: 'Telah log masuk',
    loggedInGenspark: 'Telah log masuk ke mAI Office',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke mAI Office',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2: 'mAI Office masih dalam peringkat alfa. Sertai sembang kumpulan di GenTeam.',
  ...
  he: {
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountGenspark: 'חשבון mAI Office',
    account: 'חשבון',
    login: 'התחברות',
    loginGenspark: 'התחברות ל-mAI Office',
    loggedIn: 'מחובר',
    loggedInGenspark: 'מחובר ל-mAI Office',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-mAI Office',
    ...
    onbBody2: 'mAI Office עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GenTeam.',
  ...
  hi: {
    ...
    noContent: '(खाली)',
    accountGenspark: 'mAI Office खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginGenspark: 'mAI Office में साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInGenspark: 'mAI Office में साइन इन है',
    waitingLogin:
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'mAI Office में आपका स्वागत है',
    ...
    onbBody2: 'mAI Office अभी अल्फ़ा में है। GenTeam पर ग्रुप चैट से जुड़ें।',
  ...
  'zh-TW': {
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountGenspark: 'mAI Office 帳號',
    account: '帳號',
    login: '登入',
    loginGenspark: '登入 mAI Office',
    loggedIn: '已登入',
    loggedInGenspark: '已登入 mAI Office',
