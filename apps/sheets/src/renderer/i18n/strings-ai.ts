...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiGensparkAccount: 'mAI Office 账号',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: '未登录（AI 功能需要登录 mAI Office 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiLoginGenspark: '登录 mAI Office',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
  ...
  en: {
    ...
    aiGskLoginBtn: 'Sign in to mAI Office',
    ...
    aiGensparkAccount: 'mAI Office account',
    aiAccountChecking: 'Checking…',
    aiLoggedIn: 'Signed in',
    aiLoggedInAs: 'Signed in: {email}',
    aiNotLoggedIn: 'Not signed in (AI features require a mAI Office account)',
    aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
    aiLoginGenspark: 'Sign in to mAI Office',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
  ...
  ja: {
    ...
    aiGskLoginBtn: 'mAI Office にサインイン',
    ...
    aiGensparkAccount: 'mAI Office アカウント',
    aiAccountChecking: '確認中…',
    aiLoggedIn: 'サインイン済み',
    aiLoggedInAs: 'サインイン済み: {email}',
    aiNotLoggedIn: '未サインイン（AI 機能には mAI Office アカウントへのサインインが必要です）',
    aiWaitingBrowserLogin: 'ブラウザーでのサインインを待機中…',
    aiLoginGenspark: 'mAI Office にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
  ...
  ko: {
    ...
    aiGensparkAccount: 'mAI Office 계정',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 mAI Office 계정 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    aiLoginGenspark: 'mAI Office 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
  ...
  fr: {
    ...
    aiGskLoginBtn: 'Se connecter à mAI Office',
    ...
    aiGensparkAccount: 'Compte mAI Office',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte mAI Office)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    aiLoginGenspark: 'Se connecter à mAI Office',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
  ...
  de: {
    ...
    aiGskLoginBtn: 'Bei mAI Office anmelden',
    ...
    aiGensparkAccount: 'mAI Office-Konto',
    aiAccountChecking: 'Wird überprüft…',
    aiLoggedIn: 'Angemeldet',
    aiLoggedInAs: 'Angemeldet: {email}',
    aiNotLoggedIn: 'Nicht angemeldet (KI-Funktionen erfordern ein mAI Office-Konto)',
    aiWaitingBrowserLogin: 'Warten auf Anmeldung im Browser…',
    aiLoginGenspark: 'Bei mAI Office anmelden',
    aiModel: 'Modell',
    aiCancel: 'Abbrechen',
    aiSave: 'Speichern',
  ...
  es: {
    ...
    aiGskLoginBtn: 'Iniciar sesión en mAI Office',
    ...
    aiGensparkAccount: 'Cuenta de mAI Office',
    aiAccountChecking: 'Comprobando…',
    aiLoggedIn: 'Sesión iniciada',
    aiLoggedInAs: 'Sesión iniciada: {email}',
    aiNotLoggedIn: 'Sin sesión iniciada (las funciones de IA requieren una cuenta de mAI Office)',
    aiWaitingBrowserLogin: 'Esperando el inicio de sesión en el navegador…',
    aiLoginGenspark: 'Iniciar sesión en mAI Office',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Guardar',
  ...
  th: {
    ...
    aiGskLoginBtn: 'ลงชื่อเข้าใช้ mAI Office',
  ...
  id: {
    ...
    aiGskLoginBtn: 'Masuk ke mAI Office',
  ...
  ru: {
    ...
    aiGskLoginBtn: 'Войти в mAI Office',
    ...
    aiGensparkAccount: 'Учётная запись mAI Office',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись mAI Office)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    aiLoginGenspark: 'Войти в mAI Office',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
  ...
  ar: {
    ...
    aiGskLoginBtn: 'تسجيل الدخول إلى mAI Office',
    ...
    aiGensparkAccount: 'حساب mAI Office',
    aiAccountChecking: 'جارٍ التحقق…',
    aiLoggedIn: 'تم تسجيل الدخول',
    aiLoggedInAs: 'تم تسجيل الدخول: {email}',
    aiNotLoggedIn: 'لم يتم تسجيل الدخول (تتطلب ميزات الذكاء الاصطناعي حساب mAI Office)',
    aiWaitingBrowserLogin: 'في انتظار تسجيل الدخول من المتصفح…',
    aiLoginGenspark: 'تسجيل الدخول إلى mAI Office',
    aiModel: 'النموذج',
    aiCancel: 'إلغاء',
    aiSave: 'حفظ',
  ...
  pt: {
    ...
    aiGskLoginBtn: 'Entrar no mAI Office',
    ...
    aiGensparkAccount: 'Conta mAI Office',
    aiAccountChecking: 'Verificando…',
    aiLoggedIn: 'Conectado',
    aiLoggedInAs: 'Conectado: {email}',
    aiNotLoggedIn: 'Não conectado (os recursos de IA exigem uma conta mAI Office)',
    aiWaitingBrowserLogin: 'Aguardando login no navegador…',
    aiLoginGenspark: 'Entrar no mAI Office',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Salvar',
  ...
  it: {
    ...
    aiGskLoginBtn: 'Accedi a mAI Office',
  ...
  pl: {
    ...
    aiGskLoginBtn: 'Zaloguj się do mAI Office',
    ...
    aiGensparkAccount: 'Konto mAI Office',
    aiAccountChecking: 'Sprawdzanie…',
    aiLoggedIn: 'Zalogowano',
    aiLoggedInAs: 'Zalogowano: {email}',
    aiNotLoggedIn: 'Nie zalogowano (funkcje AI wymagają konta mAI Office)',
    aiWaitingBrowserLogin: 'Oczekiwanie na logowanie w przeglądarce…',
    aiLoginGenspark: 'Zaloguj się do mAI Office',
    aiModel: 'Model',
    aiCancel: 'Anuluj',
    aiSave: 'Zapisz',
  ...
  nl: {
    ...
    aiGskLoginBtn: 'Aanmelden bij mAI Office',
    ...
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een mAI Office-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    aiLoginGenspark: 'Aanmelden bij mAI Office',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
  ...
  ms: {
    ...
    aiGskLoginBtn: 'Log masuk ke mAI Office',
  ...
  he: {
    ...
    aiGskLoginBtn: 'התחבר ל-mAI Office',
    ...
    aiGensparkAccount: 'חשבון mAI Office',
    aiAccountChecking: 'בודק…',
    aiLoggedIn: 'מחובר',
    aiLoggedInAs: 'מחובר: {email}',
    aiNotLoggedIn: 'לא מחובר (תכונות AI דורשות חשבון mAI Office)',
    aiWaitingBrowserLogin: 'ממתין לכניסה בדפדפן…',
    aiLoginGenspark: 'כניסה ל-mAI Office',
    aiModel: 'מודל',
    aiCancel: 'ביטול',
    aiSave: 'שמירה',
  ...
  hi: {
    ...
    aiGskLoginBtn: 'mAI Office में साइन इन करें',
    ...
    aiGensparkAccount: 'mAI Office खाता',
    aiAccountChecking: 'जांच हो रही है…',
    aiLoggedIn: 'साइन इन किया गया',
    aiLoggedInAs: 'साइन इन: {email}',
    aiNotLoggedIn: 'साइन इन नहीं है (AI सुविधाओं के लिए mAI Office खाता आवश्यक है)',
    aiWaitingBrowserLogin: 'ब्राउज़र में साइन इन की प्रतीक्षा…',
    aiLoginGenspark: 'mAI Office में साइन इन करें',
    aiModel: 'मॉडल',
    aiCancel: 'रद्द करें',
    aiSave: 'सहेजें',
  ...
  'zh-TW': {
    ...
    aiGensparkAccount: 'mAI Office 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 mAI Office 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiLoginGenspark: '登入 mAI Office',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
