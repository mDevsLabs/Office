...
const tMain = createI18n({
  zh: {
    ...
    errGskNotLoggedIn: '未登录 mAI Office:请点击下方「登录 mAI Office」完成登录后重试',
    ...
    menuWindow: '窗口',
    menuHelp: '帮助',
    menuDocsHelp: 'mAI Office Docs 帮助',
  },
  en: {
    ...
    errGskNotLoggedIn:
      'Not signed in to mAI Office: click “Sign in to mAI Office” below, sign in, then retry',
    ...
    menuWindow: 'Window',
    menuHelp: 'Help',
    menuDocsHelp: 'mAI Office Docs Help',
  },
  ja: {
    dlgOpenDoc: '文書を開く',
    filterWord: 'Word 文書',
    ...
    errGskNotLoggedIn:
      'mAI Office にサインインしていません。下の「mAI Office にサインイン」からサインインして再試行してください',
    ...
    menuWindow: 'ウィンドウ',
    menuHelp: 'ヘルプ',
    menuDocsHelp: 'mAI Office Docs ヘルプ',
  },
  ko: {
    dlgOpenDoc: '문서 열기',
    filterWord: 'Word 문서',
    ...
    errGskNotLoggedIn:
      'mAI Office에 로그인되어 있지 않습니다. 아래 "mAI Office 로그인"을 눌러 로그인한 뒤 다시 시도하세요',
    ...
    menuWindow: '창',
    menuHelp: '도움말',
    menuDocsHelp: 'mAI Office Docs 도움말',
  },
  fr: {
    ...
    errGskNotLoggedIn:
      'Non connecté à mAI Office : cliquez sur « Se connecter à mAI Office » ci-dessous, connectez-vous puis réessayez',
    ...
    menuWindow: 'Fenêtre',
    menuHelp: 'Aide',
    menuDocsHelp: 'Aide mAI Office Docs',
  },
  de: {
    ...
    errGskNotLoggedIn:
      'Nicht bei mAI Office angemeldet: Klicken Sie unten auf „Bei mAI Office anmelden“, melden Sie sich an und versuchen Sie es erneut',
    ...
    menuWindow: 'Fenster',
    menuHelp: 'Hilfe',
    menuDocsHelp: 'mAI Office Docs-Hilfe',
  },
  es: {
    ...
    errGskNotLoggedIn:
      'No has iniciado sesión en mAI Office: pulsa «Iniciar sesión en mAI Office» abajo, inicia sesión y vuelve a intentarlo',
    ...
    menuWindow: 'Ventana',
    menuHelp: 'Ayuda',
    menuDocsHelp: 'Ayuda de mAI Office Docs',
  },
  th: {
    ...
    errGskNotLoggedIn:
      'ยังไม่ได้ลงชื่อเข้าใช้ mAI Office: แตะ “ลงชื่อเข้าใช้ mAI Office” ด้านล่าง แล้วลองอีกครั้ง',
    ...
    menuWindow: 'หน้าต่าง',
    menuHelp: 'วิธีใช้',
    menuDocsHelp: 'วิธีใช้ mAI Office Docs',
  },
  id: {
    ...
    errGskNotLoggedIn: 'Belum masuk ke mAI Office: klik “Masuk ke mAI Office” di bawah, lalu coba lagi',
    ...
    menuWindow: 'Jendela',
    menuHelp: 'Bantuan',
    menuDocsHelp: 'Bantuan mAI Office Docs',
  },
  ru: {
    ...
    errGskNotLoggedIn:
      'Вы не вошли в mAI Office: нажмите «Войти в mAI Office» ниже, войдите и повторите попытку',
    ...
    menuWindow: 'Окно',
    menuHelp: 'Справка',
    menuDocsHelp: 'Справка mAI Office Docs',
  },
  ar: {
    ...
    errGskNotLoggedIn:
      'لم تسجّل الدخول إلى mAI Office: انقر على «تسجيل الدخول إلى mAI Office» أدناه ثم أعد المحاولة',
    ...
    menuWindow: 'نافذة',
    menuHelp: 'تعليمات',
    menuDocsHelp: 'تعليمات mAI Office Docs',
  },
  pt: {
    dlgOpenDoc: 'Abrir Documento',
    ...
    errGskNotLoggedIn:
      'Não conectado ao mAI Office: clique em “Entrar no mAI Office” abaixo, entre e tente novamente',
    ...
    menuWindow: 'Janela',
    menuHelp: 'Ajuda',
    menuDocsHelp: 'Ajuda do mAI Office Docs',
  },
  it: {
    ...
    errGskNotLoggedIn:
      'Accesso a mAI Office non effettuato: fai clic su “Accedi a mAI Office” qui sotto, accedi e riprova',
    ...
    menuWindow: 'Finestra',
    menuHelp: 'Aiuto',
    menuDocsHelp: 'Guida di mAI Office Docs',
  },
  pl: {
    ...
    errGskNotLoggedIn:
      'Nie zalogowano do mAI Office: kliknij „Zaloguj się do mAI Office” poniżej, zaloguj się i spróbuj ponownie',
    ...
    menuWindow: 'Okno',
    menuHelp: 'Pomoc',
    menuDocsHelp: 'Pomoc mAI Office Docs',
  },
  nl: {
    ...
    errGskNotLoggedIn:
      'Niet aangemeld bij mAI Office: klik hieronder op “Aanmelden bij mAI Office”, meld u aan en probeer het opnieuw',
  ...
  ms: {
    ...
    errGskNotLoggedIn:
      'Belum log masuk ke mAI Office: klik “Log masuk ke mAI Office” di bawah, kemudian cuba lagi',
  ...
  he: {
    ...
    errGskNotLoggedIn: 'לא מחובר ל-mAI Office: לחץ על "התחבר ל-mAI Office" למטה, התחבר ונסה שוב',
    ...
    menuWindow: 'חלון',
    menuHelp: 'עזרה',
    menuDocsHelp: 'עזרה של mAI Office Docs',
  },
  hi: {
    ...
    errGskNotLoggedIn:
      'mAI Office में साइन इन नहीं है: नीचे “mAI Office में साइन इन करें” पर क्लिक करें, साइन इन करें और फिर से कोशिश करें',
    ...
    menuWindow: 'विंडो',
    menuHelp: 'सहायता',
    menuDocsHelp: 'mAI Office Docs सहायता',
  },
  'zh-TW': {
    dlgOpenDoc: '開啟文件',
    filterWord: 'Word 文件',
    ...
    errGskNotLoggedIn: '未登入 mAI Office:請點擊下方「登入 mAI Office」完成登入後重試',
    ...
    menuWindow: '視窗',
    menuHelp: '說明',
    menuDocsHelp: 'mAI Office Docs 說明',
  },
})
...
export function defaultSaveDir(): string {
  const dir = join(app.getPath('documents'), 'mAI Office')
...
function savePastedImage(data: unknown, ext: unknown): string | null {
  ...
  const dir = join(app.getPath('temp'), 'mAI-office-pasted')
  mkdirSync(dir, { recursive: true })
...
export function registerAiIpc(): void {
  ...
  // mAI Office account (gsk login state): auth source for AI features; the frontend uses it to prompt login when logged out
  ipcMain.handle(
    'ai:gsk-status',
  ...
  ipcMain.handle('ai:chat', async (_event, request: AiChatRequest) => {
    ...
    try {
      return await chatForProvider(provider, effectiveConfig, system, user)
    } catch (err) {
...
export function startDocsStandalone(): void {
  ...
  // the installed mAI Office Docs is open and forwards its argv there instead.
  if (isDev) app.setPath('userData', join(app.getPath('appData'), 'mAI Office Docs Dev'))
