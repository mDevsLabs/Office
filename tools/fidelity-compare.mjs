 ...
 * Our side: playwright drives the packaged mAI Office Slides (Electron) with zoom locked at 100%,
...
/**
 * Opens mAI Office Slides and, page by page, composites the main canvas's Konva layers into a PNG
...
<table><tr><td>reference<br><img src="${rel(r.ref)}"></td><td>mAI Office Slides<br><img src="${rel(r.ours)}"></td><td>diff<br><img src="${rel(r.diff)}"></td></tr></table>`,
  )
  .join('')}
`
